...
class Buy_product(models.Model):
    buyproductBuy = models.ForeignKey(Buy, on_delete=models.CASCADE, verbose_name='buyproduct',
...
class Books(models.Model):
    booksProduct = models.OneToOneField(Product, on_delete=models.CASCADE, related_name='book')
